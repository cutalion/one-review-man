...
new_characters:
- hiroshi_tanaka
summary: Kenji Yamamoto faces Hiroshi Tanaka ('The Interview Gauntlet'), an infamous
  interviewer known for crushing developers' spirits. Effortlessly defeating Tanaka's
  coding challenges, Kenji's flawless performance is once again dismissed as luck
  by colleagues. A sudden COBOL production outage sets up Kenji's next comedic challenge.
programming_themes:
- code_review
- pair_programming
