...
require 'book_core/agent_tools/story_bible_tools'
...
module BookCore
  ...
  class WriterAgent
    ...
    def build_system_prompt(chapter_number)
      ...
      <<~PROMPT
        You are a creative writer for "#{book_config['title'] || 'One Review Man'}", a programming comedy book.
        
        BOOK CONCEPT:
        #{book_config['description'] || 'A One-Punch Man parody where the hero is a programmer so skilled that all his code reviews are approved with a single review.'}
