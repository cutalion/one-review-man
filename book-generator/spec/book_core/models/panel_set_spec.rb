...
RSpec.describe BookCore::PanelSet do
  let(:panels) do
    [
      BookCore::ComicPanel.new(sequence: 1, scene_description: 'Scene one', characters: ['kenji_yamamoto']),
      BookCore::ComicPanel.new(sequence: 2, scene_description: 'Scene two', characters: ['emily_chen'])
    ]
  end
