...
RSpec.describe BookCore::WriterAgent do
  ...
  # Mock LLM service
  let(:llm_service) do
    instance_double(BookCore::LLMService).tap do |service|
  ...
  # Mock Story Bible
  let(:story_bible) do
    instance_double(BookCore::StoryBible).tap do |bible|
  ...
  before do
    ...
    File.write(File.join(data_dir, 'book_config.yml'), {
